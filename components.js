const characterMoveComponent = {
    init() {
      ...
      //Espera a pagina carregar para iniciar a música
      window.addEventListener('load', function () {
        const music = document.querySelector('#music').components.sound
        music.playSound()
      })
      
      //Cria Controle de movimentos do personagem
    ...
    tick(time, timeDelta) {
      ...
      //Verifica qual dispositivo pelo tamanho da tela
      if (startPositionRaw) {
        ...
        // Converter a RawDistance para Movimentos do Controle
        ...
        //Atualiza as posições do Controle com a entrada do usuário
        ...
        // Pega o Y da camera para ajustar o movimento
        ...
        //Define a velocidade do persoangem
        const speed = 0.0055
